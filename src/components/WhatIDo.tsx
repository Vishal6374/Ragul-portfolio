        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Precise cuts, seamless transitions, and powerful storytelling —
                from short-form reels to long-form productions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Motion Graphics & Visual Branding</h4>
              <p>
                Stunning motion graphics, visual effects, and branded content —
                crafted to reach and resonate with the right audience.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Word</div>
